...
export class AddressBookUpdateComponent implements OnInit {
  ...
  updateForm(addressBook: IAddressBook) {
    this.editForm.patchValue({
      ...
      defaultFrom: addressBook.defaultFrom,
      defaultTo: addressBook.defaultTo,
  ...
  private createFromForm(): IAddressBook {
    return {
      ...
      defaultFrom: this.editForm.get(['defaultFrom']).value,
      defaultTo: this.editForm.get(['defaultTo']).value,
