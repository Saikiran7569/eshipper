...
import { CommodityTypeComponent } from 'app/entities/commodity-type/commodity-type.component';
...
describe('Component Tests', () => {
  describe('CommodityType Management Component', () => {
    let comp: CommodityTypeComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        declarations: [CommodityTypeComponent],
        providers: [
          {
        ...
        .overrideTemplate(CommodityTypeComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.commodityTypes && comp.commodityTypes[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
