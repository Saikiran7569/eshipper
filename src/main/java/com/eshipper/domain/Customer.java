...
public class Customer implements Serializable {
    ...
    public Customer costAccount(Integer costAccount) {
    ...
    public Customer dateCreated(ZonedDateTime dateCreated) {
    ...
    public Customer creator(Integer creator) {
    ...
    public Customer isShopifyEnable(Boolean isShopifyEnable) {
    ...
    public Customer defaultSignatureOption(Integer defaultSignatureOption) {
    ...
    public Customer addressBooks(Set<AddressBook> addressBooks) {
        this.addressBooks = addressBooks;
        return this;
    }

    public Customer addAddressBook(AddressBook addressBook) {
        this.addressBooks.add(addressBook);
        addressBook.setCustomer(this);
        return this;
    }

    public Customer removeAddressBook(AddressBook addressBook) {
