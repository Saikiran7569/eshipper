...
import { SuppliesComponent } from 'app/entities/supplies/supplies.component';
...
describe('Component Tests', () => {
  describe('Supplies Management Component', () => {
    let comp: SuppliesComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(SuppliesComponent, '')
        .compileComponents();
